...
class NicheSetup extends \Brandy\Abstracts\AbstractNicheSetup {
	...
	public static function get_niche_data() {
		$data = array(
			...
			'img'                            => 'http://img.wpbrandy.com/uploads/jewelry-light-thumbnail.png',
			'demo_url'                       => 'http://img.wpbrandy.com/uploads/light-jewelry-preview.png',
			'plan'                           => 'free',
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'brandy-jewelry-light-site-style', self::ROOT_URL . '/assets/style.css', array(), time() );
		wp_enqueue_script( 'brandy-jewelry-light-site-js', self::ROOT_URL . '/assets/script.js', array( 'jquery' ), time(), true );
	}
}
