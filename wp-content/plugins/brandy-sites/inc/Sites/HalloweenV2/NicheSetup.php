...
class NicheSetup extends \Brandy\Abstracts\AbstractNicheSetup {
	...
	public static function get_niche_data() {
		$data = array(
			...
			'img'                            => 'http://img.wpbrandy.com/uploads/halloween-v2-site-thumbnail-1-1.png',
			'demo_url'                       => 'http://img.wpbrandy.com/uploads/halloween-v2-preview.png',
			'plan'                           => 'free',
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'brandy-halloween-v2-site-style', self::ROOT_URL . '/assets/style.css', array(), time() );
		wp_enqueue_script( 'brandy-halloween-v2-site-js', self::ROOT_URL . '/assets/script.js', array( 'jquery' ), time(), true );
	}
