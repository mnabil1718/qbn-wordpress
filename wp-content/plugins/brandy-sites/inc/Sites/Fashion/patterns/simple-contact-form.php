...
<div class="brandy-simple-contact-form">
	<style>
		.brandy-simple-contact-form label {
			display: inline-block;
			margin-bottom: 7px;
		}

		.brandy-simple-contact-form-line {
			display: flex;
			align-items: center;
		...
		.brandy-simple-contact-form button[type="submit"] {
	...
	<form action="#" method="post">
		<div class="brandy-simple-contact-form-line">
		<div>
