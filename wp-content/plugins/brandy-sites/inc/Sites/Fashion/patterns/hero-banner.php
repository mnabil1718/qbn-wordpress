...
<div class="wp-block-cover is-light brandy-hero-banner has-brandy-primary-text-color has-text-color has-link-color"
	...
	<span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim"
		style="background-color:#fdf4e6"></span>
		...
		<div class="wp-block-columns alignwide" style="padding-right:0;padding-left:0">
			...
			<div class="wp-block-column is-vertically-aligned-center brandy-hero-banner__content"
				...
				<p class="has-large-to-small-font-size"
					style="margin-bottom:var(--wp--preset--spacing--10);letter-spacing:5.4px;text-transform:uppercase"><?php echo esc_html__( 'New Arrivals', 'brandy-sites' ); ?></p>
				<!-- /wp:paragraph -->
				...
				<h1 class="wp-block-heading has-text-align-left has-responsive-big-heading-font-size"
					style="margin-top:0;margin-bottom:var(--wp--preset--spacing--10);font-style:normal;font-weight:700;line-height:1.15"><?php echo esc_html__( 'Perfect Fashions', 'brandy-sites' ); ?><br><?php echo esc_html__( 'For Summer', 'brandy-sites' ); ?></h1>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"margin":{"top":"0px","bottom":"0px"}}},"fontSize":"large_to_small"} -->
				<p class="has-large-to-small-font-size"
					style="margin-top:0px;margin-bottom:0px;font-style:normal;font-weight:400"><?php echo esc_html__( 'There\'s nothing like a trend, let\'s select items to make your life with a new fashion style!', 'brandy-sites' ); ?></p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--40)">
					...
					<div class="wp-block-button has-custom-font-size has-large-font-size"
						style="font-style:normal;font-weight:600;line-height:1.75"><a
							...
							style="padding-top:0.8rem;padding-right:2rem;padding-bottom:0.8rem;padding-left:2rem"><?php echo esc_html__( 'Explore now', 'brandy-sites' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
			...
			<div class="wp-block-column is-vertically-aligned-center brandy-hero-banner__image">
				<!-- wp:image {"width":"370px","sizeSlug":"large","align":"center"} -->
				<figure class="wp-block-image aligncenter size-large is-resized"><img
						src="http://img.wpbrandy.com/uploads/fashion-banner.png" alt="" style="width:370px" /></figure>
				<!-- /wp:image -->
			</div>
			<!-- /wp:column -->
		</div>
