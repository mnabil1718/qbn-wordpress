...
<section class="woocommerce-order-downloads">
	<?php if ( isset( $show_title ) ) : ?>
		<h3 class="woocommerce-order-downloads__title"><?php esc_html_e( 'Downloads', 'brandy' ); ?></h3>
	<?php endif; ?>
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								...
								case 'download-remaining':
									echo is_numeric( $download['downloads_remaining'] ) ? esc_html( $download['downloads_remaining'] ) : esc_html__( '&infin;', 'brandy' );
									break;
