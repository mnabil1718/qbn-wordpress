...
<div class="wp-block-group"><!-- wp:buttons {"style":{"layout":{"selfStretch":"fixed","flexSize":"30px"}}} -->
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"brandy-primary-black","style":{"border":{"radius":"100px"},"spacing":{"padding":{"left":"10px","right":"10px","top":"5px","bottom":"5px"}},"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"#fefefe"}}},"color":{"text":"#fefefe"}},"fontSize":"large_to_small"} -->
<div class="wp-block-button has-custom-font-size has-large-to-small-font-size" style="font-style:normal;font-weight:700"><a class="wp-block-button__link has-brandy-primary-black-background-color has-text-color has-background has-link-color wp-element-button" href="#" style="border-radius:100px;color:#fefefe;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px"><strong>2</strong></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|brandy-primary-black"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"brandy-primary-black","fontSize":"large_to_small"} -->
<p class="has-brandy-primary-black-color has-text-color has-link-color has-large-to-small-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Shipping detail', 'brandy' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-brandy-accent-color has-text-color has-link-color has-large-to-small-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Complete', 'brandy' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
