...
<div class="wp-block-query">
	...
	<div class="wp-block-group brandy-card-shadow has-border-color" style="border-radius:10px">
		<!-- wp:group {"style":{"color":{"background":"var:preset|color|brandy-theme-secondary-background"},"border":{"radius":{"topLeft":"9px","topRight":"9px"}},"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"layout":{"type":"default"}} -->
		<div class="wp-block-group has-background"
			style="border-top-left-radius:9px;border-top-right-radius:9px;background-color:var(--wp--preset--color--brandy-theme-secondary-background);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
		...
		<div class="wp-block-group" style="padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
			...
			<!-- wp:post-excerpt {"moreText":"Continue reading","excerptLength":56,"style":{"elements":{"link":{"color":{"text":"var:preset|color|brandy-primary-text"},":hover":{"color":{"text":"var:preset|color|brandy-primary-text"}}}}},"textColor":"brandy-primary-text"} /-->
		</div>
		<!-- /wp:group -->
	</div>
	<!-- /wp:group -->
